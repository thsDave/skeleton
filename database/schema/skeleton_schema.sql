...
CREATE TABLE `tbl_mfa_settings` (
  ...
  `sms_provider` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sms_api_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sms_api_secret_enc` text COLLATE utf8mb4_unicode_ci,
  `sms_from` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sms_endpoint` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sms_extra_config` json DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_two_factor_codes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `code_hash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SHA-256 del cÃ³digo de 6 dÃ­gitos',
...
CREATE TABLE `tbl_users` (
  ...
  `two_factor_method` enum('email','sms','authenticator') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `two_factor_secret_enc` text COLLATE utf8mb4_unicode_ci,
  `two_factor_phone` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `tbl_languages` (`id`, `name`, `native_name`, `code`, `is_default`, `status_id`, `created_at`, `updated_at`) VALUES (1,'EspaÃ±ol','EspaÃ±ol','es',1,1,'2026-05-09 17:40:22',NULL),(2,'English','English','en',0,1,'2026-05-09 17:40:22',NULL);
...
INSERT INTO `tbl_modules` (`id`, `name`, `slug`, `description`, `icon`, `route`, `sort_order`, `status_id`, `created_at`, `updated_at`) VALUES (1,'Dashboard','dashboard','Panel principal del sistema','ph-duotone ph-gauge','/dashboard',1,1,'2026-05-09 17:40:35',NULL),(2,'Mi Perfil','profile','Perfil personal del usuario','ph-duotone ph-user-circle','/profile',2,1,'2026-05-09 17:40:35',NULL),(3,'Mi Cuenta','account','Credenciales de acceso','ph-duotone ph-gear','/account',3,1,'2026-05-09 17:40:35',NULL),(4,'Usuarios','users','GestiÃ³n de usuarios del sistema','ph-duotone ph-users-three','/users',4,1,'2026-05-09 17:40:35',NULL),(5,'Idiomas','languages','GestiÃ³n de idiomas del sistema','ph-duotone ph-translate','/languages',5,1,'2026-05-09 17:40:35',NULL),(6,'InformaciÃ³n del Sistema','system_information','Datos e informaciÃ³n general del sistema','ph-duotone ph-info','/system-information',6,1,'2026-05-09 17:40:35',NULL),(7,'Manuales','manuals','Manuales de usuario','ph-duotone ph-file-text','/system-information',7,1,'2026-05-09 17:40:35',NULL),(8,'Seguridad / Sesiones','security_sessions','ConfiguraciÃ³n de bloqueo de sesiÃ³n','ph-duotone ph-lock-key','/security/sessions',8,1,'2026-05-09 17:40:35',NULL),(9,'Roles y Permisos','roles_permissions','GestiÃ³n de permisos por rol','ph-duotone ph-shield-check','/roles-permissions',9,1,'2026-05-09 17:40:35',NULL),(10,'AuditorÃ­a','audit_logs','Registros de auditorÃ­a del sistema','ph-duotone ph-clipboard-text','/audit-logs',10,1,'2026-05-09 17:40:41',NULL),(11,'Seguridad / SMTP','security_smtp','ConfiguraciÃ³n SMTP del sistema','ph-duotone ph-envelope','/security/smtp',10,1,'2026-05-09 17:40:51',NULL),(12,'MFA','security_mfa','ConfiguraciÃ³n global de autenticaciÃ³n multifactor','ph-duotone ph-shield-plus','/security/mfa',11,1,'2026-05-09 17:40:55',NULL),(13,'Intentos','security_attempts','ConfiguraciÃ³n de protecciÃ³n contra intentos fallidos de login','ph-duotone ph-shield-warning','/security/attempts',12,1,'2026-05-09 19:22:14',NULL),(14,'AutenticaciÃ³n','security_authentication','ConfiguraciÃ³n de mÃ©todos de inicio de sesiÃ³n: local y proveedores externos OAuth','ph-duotone ph-sign-in','/security/authentication',11,1,'2026-05-10 02:18:21',NULL),(15,'Apariencia','appearance','ConfiguraciÃ³n visual del sistema: logo, favicon, fondo de login y colores','ph-duotone ph-palette','/appearance',12,1,'2026-05-10 06:35:00',NULL),(16,'PolÃ­tica de ContraseÃ±as','security_password_policy','ConfiguraciÃ³n de reglas de seguridad para contraseÃ±as del sistema','ph-duotone ph-password','/security/password-policy',13,1,'2026-05-11 05:23:19',NULL),(17,'Salud del Sistema','system_health','Panel tecnico de verificaciones del sistema','ph-duotone ph-heartbeat','/system-health',12,1,'2026-05-13 03:02:49',NULL),(18,'Mantenimiento','maintenance','Herramientas administrativas de mantenimiento','ph-duotone ph-broom','/maintenance/cleanup',13,1,'2026-05-13 04:19:34',NULL),(19,'Notificaciones','notifications','Notificaciones internas del usuario','ph-duotone ph-bell','/notifications',14,1,'2026-05-13 04:37:58',NULL);
INSERT INTO `tbl_permissions` (`id`, `module_id`, `name`, `slug`, `description`, `created_at`, `updated_at`) VALUES (1,1,'Ver Dashboard','dashboard.view','Acceso al panel principal','2026-05-09 17:40:35',NULL),(2,2,'Ver Perfil','profile.view','Ver informaciÃ³n del perfil','2026-05-09 17:40:35',NULL),(3,2,'Editar Perfil','profile.edit','Editar informaciÃ³n del perfil','2026-05-09 17:40:35',NULL),(4,3,'Ver Cuenta','account.view','Ver configuraciÃ³n de cuenta','2026-05-09 17:40:35',NULL),(5,3,'Editar Cuenta','account.edit','Editar correo y contraseÃ±a','2026-05-09 17:40:35',NULL),(6,4,'Ver Usuarios','users.view','Ver lista de usuarios','2026-05-09 17:40:35',NULL),(7,4,'Crear Usuarios','users.create','Crear nuevos usuarios','2026-05-09 17:40:35',NULL),(8,4,'Editar Usuarios','users.edit','Editar usuarios existentes','2026-05-09 17:40:35',NULL),(9,4,'Eliminar Usuarios','users.delete','Inactivar usuarios','2026-05-09 17:40:35',NULL),(10,5,'Ver Idiomas','languages.view','Ver lista de idiomas','2026-05-09 17:40:35',NULL),(11,5,'Crear Idiomas','languages.create','Crear nuevos idiomas','2026-05-09 17:40:35',NULL),(12,5,'Editar Idiomas','languages.edit','Editar idiomas existentes','2026-05-09 17:40:35',NULL),(13,5,'Activar Idiomas','languages.activate','Activar idiomas del sistema','2026-05-09 17:40:35',NULL),(14,5,'Desactivar Idiomas','languages.deactivate','Desactivar idiomas del sistema','2026-05-09 17:40:35',NULL),(15,6,'Ver InformaciÃ³n del Sistema','system_information.view','Ver datos del sistema','2026-05-09 17:40:35',NULL),(16,6,'Editar InformaciÃ³n del Sistema','system_information.edit','Editar datos del sistema','2026-05-09 17:40:35',NULL),(17,7,'Ver Manuales','manuals.view','Ver y descargar manuales','2026-05-09 17:40:35',NULL),(18,7,'Subir Manuales','manuals.upload','Subir nuevos manuales','2026-05-09 17:40:35',NULL),(19,7,'Editar Manuales','manuals.edit','Editar datos de manuales','2026-05-09 17:40:35',NULL),(20,7,'Activar Manuales','manuals.activate','Activar manuales','2026-05-09 17:40:35',NULL),(21,7,'Desactivar Manuales','manuals.deactivate','Desactivar manuales','2026-05-09 17:40:35',NULL),(22,8,'Ver Seguridad / Sesiones','security_sessions.view','Ver configuraciÃ³n de sesiÃ³n','2026-05-09 17:40:35',NULL),(23,8,'Editar Seguridad / Sesiones','security_sessions.edit','Editar configuraciÃ³n de sesiÃ³n','2026-05-09 17:40:35',NULL),(24,9,'Ver Roles y Permisos','roles_permissions.view','Ver mÃ³dulo de roles y permisos','2026-05-09 17:40:35',NULL),(25,9,'Editar Roles y Permisos','roles_permissions.edit','Editar permisos de roles','2026-05-09 17:40:35',NULL),(26,10,'Ver AuditorÃ­a','audit_logs.view','Ver listado de registros de auditorÃ­a','2026-05-09 17:40:41',NULL),(27,10,'Ver Detalle AuditorÃ­a','audit_logs.show','Ver detalle de un registro de auditorÃ­a','2026-05-09 17:40:41',NULL),(28,11,'Ver SMTP','security_smtp.view','Ver configuraciÃ³n SMTP','2026-05-09 17:40:51',NULL),(29,11,'Editar SMTP','security_smtp.edit','Editar configuraciÃ³n SMTP','2026-05-09 17:40:51',NULL),(30,11,'Probar SMTP','security_smtp.test','Enviar correo de prueba SMTP','2026-05-09 17:40:51',NULL),(31,12,'Ver ConfiguraciÃ³n MFA','security_mfa.view','Acceso de lectura al mÃ³dulo MFA','2026-05-09 17:40:55',NULL),(32,12,'Editar ConfiguraciÃ³n MFA','security_mfa.edit','Guardar configuraciÃ³n global MFA','2026-05-09 17:40:55',NULL),(33,12,'Probar SMS MFA','security_mfa.test','Enviar SMS de prueba desde el mÃ³dulo MFA','2026-05-09 17:40:55',NULL),(34,4,'Desbloquear Usuario','users.unlock','Permite desbloquear cuentas de usuario bloqueadas por intentos fallidos','2026-05-09 17:41:12',NULL),(35,13,'Ver Intentos fallidos','security_attempts.view','Permite ver la configuraciÃ³n de intentos fallidos de login','2026-05-09 19:22:14',NULL),(36,13,'Editar Intentos fallidos','security_attempts.edit','Permite editar la configuraciÃ³n de intentos fallidos de login','2026-05-09 19:22:14',NULL),(37,14,'Ver AutenticaciÃ³n','security_authentication.view','Permite ver la configuraciÃ³n de mÃ©todos de autenticaciÃ³n','2026-05-10 02:18:21',NULL),(38,14,'Editar configuraciÃ³n general','security_authentication.edit','Permite editar la configuraciÃ³n general de autenticaciÃ³n','2026-05-10 02:18:21',NULL),(39,14,'Configurar proveedores','security_authentication.providers_create','Permite configurar proveedores de autenticaciÃ³n externos','2026-05-10 02:18:21',NULL),(40,14,'Editar proveedores','security_authentication.providers_edit','Permite editar la configuraciÃ³n de proveedores externos','2026-05-10 02:18:21',NULL),(41,14,'Eliminar proveedores','security_authentication.providers_delete','Permite restablecer o eliminar proveedores externos','2026-05-10 02:18:21',NULL),(42,14,'Probar proveedores','security_authentication.providers_test','Permite probar la configuraciÃ³n de proveedores externos','2026-05-10 02:18:21',NULL),(43,15,'Ver Apariencia','appearance.view','Permite ver la configuraciÃ³n de apariencia del sistema','2026-05-10 06:35:00',NULL),(44,15,'Editar Apariencia','appearance.edit','Permite modificar la configuraciÃ³n de apariencia del sistema','2026-05-10 06:35:00',NULL),(45,15,'Restablecer Apariencia','appearance.reset','Permite restablecer elementos de apariencia a sus valores por defecto','2026-05-10 06:35:00',NULL),(46,16,'Ver PolÃ­tica de ContraseÃ±as','security_password_policy.view','Permite ver la configuraciÃ³n de polÃ­tica de contraseÃ±as','2026-05-11 05:23:19',NULL),(47,16,'Editar PolÃ­tica de ContraseÃ±as','security_password_policy.edit','Permite editar la configuraciÃ³n de polÃ­tica de contraseÃ±as','2026-05-11 05:23:19',NULL),(48,7,'Eliminar Manuales','manuals.delete','Eliminar manuales mediante borrado logico','2026-05-12 00:22:28',NULL),(49,4,'Exportar Usuarios','users.export','Exportar listado de usuarios en formato Excel','2026-05-12 00:39:58',NULL),(50,10,'Exportar Auditoria','audit_logs.export','Exportar registros de auditoria en formato Excel','2026-05-12 00:39:58',NULL),(51,3,'Ver sesiones propias','account.sessions.view','Ver sesiones activas propias','2026-05-12 16:00:51',NULL),(52,3,'Cerrar sesiones propias','account.sessions.revoke','Cerrar sesiones activas propias','2026-05-12 16:00:51',NULL),(53,8,'Ver sesiones activas','security_sessions.view_active','Ver sesiones activas de usuarios','2026-05-12 16:00:51',NULL),(54,8,'Cerrar sesion activa','security_sessions.revoke','Cerrar una sesion activa','2026-05-12 16:00:51',NULL),(55,8,'Cerrar sesiones de usuario','security_sessions.revoke_user_all','Cerrar todas las sesiones activas de un usuario','2026-05-12 16:00:51',NULL),(56,3,'Ver historial de sesiones propias','account.sessions.history','Consultar historial propio de sesiones','2026-05-12 16:34:41',NULL),(57,4,'Ver historial de sesiones de usuarios','users.sessions.view','Consultar historial de sesiones de usuarios','2026-05-12 16:34:41',NULL),(58,4,'Cerrar sesion desde historial','users.sessions.revoke','Cerrar una sesion activa desde historial de usuarios','2026-05-12 16:34:41',NULL),(59,4,'Cerrar todas las sesiones desde historial','users.sessions.revoke_all','Cerrar sesiones activas de un usuario desde historial','2026-05-12 16:34:41',NULL),(60,17,'Ver Salud del Sistema','system_health.view','Acceso al panel de salud del sistema','2026-05-13 03:02:49',NULL),(61,18,'Ver limpieza de datos temporales','maintenance.cleanup.view','Ver resumen de datos temporales limpiables','2026-05-13 04:19:34',NULL),(62,18,'Ejecutar limpieza de datos temporales','maintenance.cleanup.run','Ejecutar limpieza controlada de datos temporales','2026-05-13 04:19:34',NULL),(63,19,'Ver notificaciones','notifications.view','Ver notificaciones internas propias','2026-05-13 04:37:58',NULL),(64,19,'Marcar notificaciones como leidas','notifications.mark_read','Marcar notificaciones internas propias como leidas','2026-05-13 04:37:58',NULL);
INSERT INTO `tbl_role_permissions` (`id`, `role_id`, `permission_id`, `created_at`) VALUES (32,2,5,'2026-05-09 17:40:35'),(33,2,4,'2026-05-09 17:40:35'),(34,2,1,'2026-05-09 17:40:35'),(35,2,17,'2026-05-09 17:40:35'),(36,2,3,'2026-05-09 17:40:35'),(37,2,2,'2026-05-09 17:40:35'),(38,2,15,'2026-05-09 17:40:35'),(39,3,5,'2026-05-09 17:40:35'),(40,3,4,'2026-05-09 17:40:35'),(41,3,1,'2026-05-09 17:40:35'),(42,3,17,'2026-05-09 17:40:35'),(43,3,3,'2026-05-09 17:40:35'),(44,3,2,'2026-05-09 17:40:35'),(45,3,15,'2026-05-09 17:40:35'),(298,3,51,'2026-05-12 16:00:51'),(299,3,52,'2026-05-12 16:00:51'),(300,2,51,'2026-05-12 16:00:51'),(301,2,52,'2026-05-12 16:00:51'),(307,3,56,'2026-05-12 16:34:41'),(308,2,56,'2026-05-12 16:34:41'),(312,1,1,'2026-05-13 02:24:05'),(313,1,2,'2026-05