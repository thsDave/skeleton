...
<?php if (\Core\Lang::getLocale() === 'es'): ?>
<!-- Select2 i18n (idioma activo: es) — necesario para que Select2 muestre
     sus mensajes internos (sin resultados, buscando, etc.) en español;
     sin este paquete, Select2 siempre usa su inglés por defecto. -->
...
$(document).ready(function () {
  $('.select2').select2({ theme: 'bootstrap-5', width: '100%', language: <?= json_encode(\Core\Lang::getLocale() === 'es' ? 'es' : 'en') ?> });
});
</script>
