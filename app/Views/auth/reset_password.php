...
<html lang="es">
<head>
  <title><?= __('auth.reset_password_title') ?> | <?= htmlspecialchars((string) env('APP_NAME', 'Skeleton'), ENT_QUOTES, 'UTF-8') ?></title>
  <meta charset="utf-8" />
    ...
    <div class="auth-form">
      <div class="card my-5">
        <div class="card-body">
          ...
          <h5 class="mb-1 f-w-500 text-center"><?= __('auth.reset_password_title') ?></h5>
          <p class="text-muted text-center mb-4 small"><?= __('auth.reset_password_subtitle') ?></p>
...
?>
            ...
            <div class="mb-4">
              <label for="confirm_password" class="form-label fw-semibold">
                <?= __('auth.confirm_new_password') ?> <span class="text-danger">*</span>
              </label>
              <div class="input-group">
            ...
            <button type="submit" class="btn btn-primary w-100 mb-3">
              <i class="ph-duotone ph-lock-key me-2"></i><?= __('auth.reset_password_button') ?>
            </button>
          </form>
