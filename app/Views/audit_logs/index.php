...
// Build query string without losing current filters on form resubmit
$queryParts = [];
...
$currentQuery = $queryParts ? '?' . implode('&', $queryParts) : '';
?>
...
<div class="card mb-3">
  <div class="card-header">
    <h6 class="mb-0"><i class="ph-duotone ph-funnel me-2"></i><?= __('audit_logs.filters') ?></h6>
  </div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header d-flex align-items-center justify-content-between">
    <h5 class="mb-0">
      <i class="ph-duotone ph-clipboard-text me-2"></i>
      <?= __('audit_logs.list') ?>
    </h5>
  ...
  <div class="card-body p-0">
    <div class="table-responsive">
      <table class="table table-hover datatable-audit mb-0" style="width:100%">
        <thead>
          <tr>
            <th>#</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <?= htmlspecialchars($actionLabel ?: ($log['action'] ?? '—'), ENT_QUOTES, 'UTF-8') ?>
            </td>
            <td>
              <?php if ($log['entity']): ?>
          ...
          <tr>
            <td colspan="9" class="text-center text-muted py-4">
              <i class="ph-duotone ph-clipboard-text" style="font-size:2rem;"></i>
...
$(document).ready(function () {
  if ($.fn.DataTable.isDataTable('.datatable-audit')) {
    $('.datatable-audit').DataTable().destroy();
  }
